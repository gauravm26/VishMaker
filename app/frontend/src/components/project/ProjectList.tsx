    ...
    if (listError) {
        return (
            <div className="text-center py-8">
                ...
                <p className="text-gray-300 text-sm mb-4">{listError}</p>
                <button
                    onClick={triggerRefresh}
                    className="px-4 py-2 bg-gradient-to-r from-purple-500 to-blue-600 hover:from-purple-600 hover:to-blue-700 text-white rounded-lg transition-all duration-300 font-medium"
                >
                    Try Again
                </button>
            </div>
